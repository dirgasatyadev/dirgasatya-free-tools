...
export const codeFormatterAliases: ToolAliasRoute[] = [
  ...
  { path: '/tools/sql-formatter', name: 'sql-formatter', title: 'SQL Formatter & Minifier', description: 'Beautify keyword dan minify query SQL langsung di browser.', language: 'sql' },
]
