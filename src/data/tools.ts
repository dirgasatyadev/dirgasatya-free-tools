...
export const toolRegistry: RegisteredTool[] = [
  ...
  { id: 37, toolKey: 'text-diff-checker', name: 'Text Diff Checker', description: 'Bandingkan teks side-by-side dengan highlight added, deleted, dan changed.', category: 'Text', icon: 'mdi:file-compare-outline', path: '/tools/text-diff-checker', inputMimeTypes: [], status: 'available', component: () => import('@/pages/TextDiffCheckerPage.vue') },
]
