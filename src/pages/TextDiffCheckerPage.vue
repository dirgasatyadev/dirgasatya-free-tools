...
<template>
  <ToolPageShell title="Text Diff Checker" description="Bandingkan dua teks secara side-by-side dengan highlight baris ditambahkan, dihapus, dan diubah." icon="mdi:file-compare-outline" category="Text">
